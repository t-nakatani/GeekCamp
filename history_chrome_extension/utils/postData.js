...
export const postUniqueHostnames = async (urls) => {
    ...
    try {
        await axios.post(baseURL + 'host/', json_data);
...
export const postUrls = async (urls, titles) => {
    ...
    try {
        await axios.post(baseURL + 'url/', json_data);
...
export const postBrowsingHistories = async (urls, userId) => {
